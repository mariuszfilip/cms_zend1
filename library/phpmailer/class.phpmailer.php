 ...
 */
  ...
  */
  ...
  public function CreateHeader() {
    ...
    $result .= $this->HeaderLine('X-Mailer', 'mail');
  ...
  */
  ...
  /**
   * 
   * Delete key CustomHeader
   * @param $key
   */
  public function ClearCustomHeadersByKey($key) {
   foreach($this->CustomHeader as $key_array => $value){
       if($value[0] == $key){
            unset($this->CustomHeader[$key_array]);       
       }
   }
  }
